...
if do_fit:
    ...
    all_eci = cefit.all_data_fit(count, enrg)
    with open('all_eci_out', 'w') as filehandle:
    ...
    if fit_lasso:
        ...
        with open('lasso_eci_out', 'w') as filehandle:
    ...
    if fit_ridge:
        ...
        with open('ridge_eci_out', 'w') as filehandle:
    ...
    if fit_eln:
        ...
        with open('eln_eci_out', 'w') as filehandle:
